...
def __lldb_init_module(debugger, internal_dict):
    debugger.HandleCommand('command script add -f move.handle_command move -h "Short documentation here"')
...
def handle_command(debugger, command, exe_ctx, result, internal_dict):
    ...
    result.AppendMessage('Hello! the move command is working!')


def generate_option_parser():
    usage = "usage: %prog [options] TODO Description Here :]"
    parser = optparse.OptionParser(usage=usage, prog="move")
